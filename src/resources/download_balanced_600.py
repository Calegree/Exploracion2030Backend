...
# Configuración balanceada: 600 Morchella, 400 No-Morchella
ESPECIES_BALANCED_600 = {
    'morchella': [
        ('Morchella esculenta', 100),
        ('Morchella tridentina', 100),
        ('Morchella andinensis', 25),
        ('Morchella aysenina', 6),
        ('Morchella', 369),  # Morchella spp sin ID específico
    ],
    'no_morchella': [
        ('Gyromitra esculenta', 80),
...
class DownloadBalanced600(Resource):
    @swag_from('../flasgger/download_balanced_600.yml')
    def post(self):
        """
        Descarga dataset balanceado: 600 Morchella + 400 No-Morchella
        ...
        try:
            ...
            print("📥 Iniciando descarga de dataset balanceado (600-400)...")
            
            total_downloaded = {'morchella': 0, 'no_morchella': 0}
            total_failed = {'morchella': 0, 'no_morchella': 0}
            
            for folder, especies_list in ESPECIES_BALANCED_600.items():
            ...
            summary = {
                'status': 'success',
                'message': 'Dataset balanceado 600-400 descargado',
                'statistics': {
                    'morchella': {
